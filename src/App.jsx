      ...
      <nav className="top-nav">
        ...
        {activeUser ? (
          <div className="user-status">
            ...
            <button type="button" className="logout-btn" onClick={() => { setActiveUser(null); setShowAuth(false); }}>Logout</button>
          </div>
        ) : (
          <button className="login-btn" type="button" onClick={() => setShowAuth((v) => !v)}>
